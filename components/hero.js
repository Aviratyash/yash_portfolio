...
<p className="mt-3 text-slate-300 max-w-xl">{siteMetadata.title} — Hands-on experience in Security monitoring, SIEM (ELK, Splunk, Wazuh), IDS/IPS, threat hunting and digital forensics. Ranked in Top 5% on TryHackMe.</p>
